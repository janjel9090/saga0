...
if (strpos($result2, ',"cvc_check":"pass",')) {
  ...
  echo '<span class="badge badge-success">#Aprovada</span> </span> <span class="badge badge-warning">'.$lista.'</span> <span class="badge badge-success"><b><i>2nd req: pass<b></i> [] <b><i>3rd req: '.$check2.''.$message.'</b></i> [] Luffy </span> </span> ';
}
elseif (strpos($result2, "Your card's security code is incorrect.")) {
  fwrite(fopen('CCN.txt', 'a'), $lista."\r\n");
  echo '<span class="badge badge-warning">#Aprovada</span> <span class="badge badge-danger">'.$lista.'</span> <span class="badge badge-warning">sᴇᴄᴜʀɪᴛʏ ᴄᴏᴅᴇ ɪs ɪɴᴄᴏʀʀᴇᴄᴛ| luffy</span>';
}
...
elseif(strpos($result2, 'Your card has insufficient funds.')) {
  fwrite(fopen('insufficient.txt', 'a'), $lista."\r\n");
   echo '<span class="badge badge-success">#Aprovada</span> </span> <span class="badge badge-danger">'.$lista.'</span> <span class="badge badge-success"> '.$mesg.' | ᴢʏɴᴄʙᴏɪ </span> </span> ';
}
